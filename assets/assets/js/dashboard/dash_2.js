        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                var options1 = {
                        ...
                        events: {
                            mounted: function (ctx, config) {
                                ...
                                ctx.addPointAnnotation({
                                    ...
                                    customSVG: {
                                        SVG: '<svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="#517000" stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" class="feather feather-circle"><circle cx="12" cy="12" r="10"></circle></svg>',
                                        cssClass: undefined,
                                        offsetX: -8,
                                        offsetY: 5
                                    }
                    ...
                    colors: ['#1b55e2', '#e7515a', '#00AFB9', '#517000'],
                    dataLabels: {
                        enabled: false
                    },
                    markers: {
