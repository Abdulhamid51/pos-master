...
class RecieveItem(models.Model):
    ...
    product = models.ForeignKey(ProductFilial, on_delete=models.CASCADE, related_name='recieve_item')
    som = models.IntegerField(default=0)
...
class Cart(models.Model):
    ...
    product = models.ForeignKey(ProductFilial, on_delete=models.CASCADE, related_name='cart')
