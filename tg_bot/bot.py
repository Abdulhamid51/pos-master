...
import json
import requests
from api.models import Wallet, Debtor, Cart, Shop, Kirim, MOrder, UserProfile
import datetime
...
def open_web_app_directly(chat_id):
    web_app_url = f"https://ecomarf.kabinett.uz/abot/abot_index/{chat_id}/"
    return send_message(
        chat_id,
        " ",  # Empty message
...
def send_menu(chat_id):
    web_app_url = f"https://ecomarf.kabinett.uz/bot/abot_index/{chat_id}"
    url = f"https://api.telegram.org/bot{settings.TELEGRAM_BOT_TOKEN}/sendMessage"
